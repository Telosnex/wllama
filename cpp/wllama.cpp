...
extern "C" const char *wllama_action(const char *name, const char *req_raw)
{
  try
  {
    ...
    WLLAMA_ACTION(server_context_poc_load)
    WLLAMA_ACTION(server_context_poc_completion)
    WLLAMA_ACTION(server_context_poc_unload)
    WLLAMA_ACTION(server_context_poc)
