...
export class Wllama {
  ...
  async createEmbedding(
    ...
    return await this.getResponse(options as any, false, result.request_id);
  }
  ...
  private async getRerankResult(requestId: number): Promise<{
    score: number;
  ...
  private async getResponse(
    ...
    try {
      ...
      if (shouldReleaseReader) {
        await this.proxy
          .wllamaAction<GlueMsgReleaseResultReaderRes>(
